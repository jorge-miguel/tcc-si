...
<div class="container-fluid">
  <h1 class="ls-title-intro ls-ico-home">Editar empresa</h1>
<div class="ls-box">
  ...
  {!! Form::model($empresa, ['class' => 'ls-form row', 'data-ls-module' => 'form', 'method' => 'PATCH','route' => ['empresas.update', $empresa->id]]) !!}
